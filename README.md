...
Download [Google-Drive-Direct-main.zip](https://github.com/donPabloNow/Google-Drive-Direct/releases/tag/1.0.0.1)
...
Gmail→SMS 
Sends selected text via Gmail→SMS text message to any US mobile telephone
